...
// Порядок: сначала «свечи» (базовая визитная карточка тарифа),
// затем природа/рассветы/закаты, затем иконы и ангелы.
const RAW_IMAGE_NUMBERS = [
  37, 16, 40, 19, 18,                  // свечи: ряды у гроба, большие, россыпь, лампады, лампадник
  1,  2,  3,  4,  5,  6,  7,  8,       // природа
  23, 25, 26, 27, 30, 31, 32, 33, 34, 35, 36, // моря/рассветы/звёзды
  9,  10, 11, 12, 13, 14, 15, 17,      // иконы и ангелы
  20, 21, 22,
];
